      ...
      >
        <div className="POne">
          <p style={{ marginBottom: '30px' }}>
            ...
            دارند. اگر مدیر، مسئول شهری یا تصمیم گیرنده شهر یا بخشی از آن هستید، از خود این سوال را
            بپرسید:
          </p>
          <p className="PD">
            آیا فعالیت هایی که تا کنون در شهر رقم زده اید، موجب شده است که در باور شهروندان یا
            گردشگران، آن چیزی شکل بگیرد که برایش برنامه ریزی و تلاش کرده اید؟!
          </p>
          <p>
            برندینگ شهری (یا برندسازی شهری) مجموعه فعالیت هایی است که به مرور موجب می شود مخاطبان
            شهر، حتی با شنیدن نام آن شهر ، همان تصویر و احساس منحصر به فردی را تجربه کنند که برایش
            از سال ها پیش برنامه ریزی کرده ایم؛ چه برسد به این که آنجا اوقاتی را سپری کنند!
          </p>
        </div>
        <div className="PTwo">
          <p>
            برند شهری همین قدر کمال گرایانه، پیچیده و حیاتی است! اما بی شک اقدامات خرد، کوچک و محدود
            نیز، مهم و اثربخش است. ما در حس یک نگاه به ارائه خدمات تخصصی برندینگ شهری در مقیاس شهر،
            محله، خیابان، مجتمع و فضا می پردازیم
          </p>
        </div>
