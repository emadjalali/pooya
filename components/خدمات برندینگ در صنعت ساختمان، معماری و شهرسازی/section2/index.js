      ...
      <div className="containerD">
        ...
        <div className="patternOne">
          ...
          <div>
            <Link
              className="a"
              href={'home-fr/section2Pages/ContentProduction'}
              style={{ color: 'black', display: 'block', textAlignLast: 'justify' }}
            >
              تولید محتوای تخصصی و اختصاصی
            </Link>
            <Link
              className="a"
              href={'home-fr/section2Pages/ContentProduction'}
        ...
        <div className="patternFour">
          ...
          <div style={{ textAlignLast: 'justify' }}>
            <Link
              className="a"
              href={'/home-fr/section2Pages/CreateProject'}
              style={{ color: 'black' }}
            >
        ...
        <div className="patternThree" style={{ justifySelf: 'end', textAlignLast: 'justify' }}>
          <Image src={pattern4} />
          <div style={{ textAlignLast: 'justify' }}>
            <Link className="a" href="#" style={{ color: 'black', fontKerning: 'none' }}>
        ...
        <div className="patternSeven">
          ...
          <Link
            className="a"
            href={'home-fr/section2Pages/Complication'}
            style={{ color: 'black' }}
          >
            عارضه یابی برند{' '}
          </Link>
        ...
        <div className="patternFive" style={{ justifySelf: 'end', textAlignLast: 'justify' }}>
          ...
          <div style={{ textAlignLast: 'justify' }}>
            <Link
              className="a"
              href={'/home-fr/section2Pages/creativeSolution'}
              style={{ color: 'black' }}
            >
